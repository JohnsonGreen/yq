...
<div class="settings" style="display: none;">
    <form id="settings">
        ...
        <div class="settings-content"><span>账号</span><span
                style="height: 20px; width: 40%; margin-right: 35%; float: right;" class="settings-account"></span>
        </div>

        <div class="settings-content"><span>积分</span><span
                style="height: 20px; width: 40%; margin-right: 35%; float: right;" class="settings-mark"></span></div>

        <div class="settings-content"><span>真实姓名</span><input class="settings-realname settings-input" type="text"
                                                              name="realname"></div>
        <div class="settings-content"><span>邮箱</span><input class="settings-mail settings-input" type="text"
                                                            name="email"></div>
        <div class="settings-content"><span>所属单位</span>
            <select style="float: right; margin-right: 35%; width: 40%;" class="school" name="choose_school">
                <option value="全部">全部</option>
            </select>
        </div>
        <div class="settings-content"><span>手机号码</span><input class="settings-phone settings-input" type="text"
                                                              name="phone"></div>


        <div style="background-color: #e5e5e5; width: 100%; height: 6%; padding-top: 4px; padding-bottom: 4px;"><span
                style="margin-left: 8%;">修改密码</span></div>
        <div class="settings-content"><span>原始密码</span><input class="originpassword settings-input" type="password"
                                                              name="originpassword"></div>
        <div class="settings-content"><span>新密码</span><input class="newpassword settings-input" type="password"
                                                             name="password"></div>
...
<!--上报舆情-->
<form id="send" class="send single-send" method="POST" enctype="multipart/form-data" style="display: none;">
...
<div class="opinion" style="display: none;">
    ...
    <div class="opinion-all">
        ...
        <div class="opinion-page">
            <a href="">首页</a>
            <a href="" onclick="return ceshi(i)">上一页</a>
            <span>1</span>
            <a href="">下一页</a>
            <a href="">末页</a>

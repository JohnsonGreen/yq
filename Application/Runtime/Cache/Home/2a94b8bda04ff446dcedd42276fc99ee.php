...
<head>
    ...
    <link href="/yq/Public/editor/css/font-awesome.min.css?<?php echo rand(3000,4000); ?>" rel="stylesheet" >
    <link href="/yq/Public/editor/css/froala_page.min.css?<?php echo rand(3000,4000); ?>" rel="stylesheet" >
    <link href="/yq/Public/editor/css/froala_editor.min.css?<?php echo rand(3000,4000); ?>" rel="stylesheet" >
...
<!--移动端导航栏-->
<div class="showing">
    <a href="javascript:void(0)" onclick="showMenu()"><img class="menuimg" src="/yq/Public/images//menu.png"
...
<div class="details" style="display: none;">
    ...
    <!--<h3 style="margin-bottom: 5px; margin-left: 5px;">回复</h3>-->
		...
		<!--<textarea width="80%" height="200px " class="details-comments">-->

		<!--</textarea>-->
    <button style="float: left;" type="button" onclick="return view.back(model.lastpage)">返回</button>
    <button id="pubButton" type="button" onclick="return ctrl.comment()">发表</button>
</div>
...
<form id="send" class="send single-send" enctype="multipart/form-data" style="display: none;">
    ...
    <button style="margin-bottom: 100px;" type="button" onclick="return ctrl.singlesend()">发布</button>
</form>
...
<script async type="text/javascript" src="/yq/Public/js/arrowctrl.js?<?php echo rand(3000,4000); ?>"></script>
<script type="text/javascript" src="/yq/Public/js/calendar.js?<?php echo rand(3000,4000); ?>"></script>
<script async type="text/javascript" src="/yq/Public/js/pageProcess.js?<?php echo rand(3000,4000); ?>">
</script>
...
<script src="/yq/Public/editor/js/libs/jquery-1.11.1.min.js"></script>
<script src="/yq/Public/editor/js/froala_editor.min.js"></script>
<!--[if lt IE 9]>
<script async src="/yq/Public/editor/js/froala_editor_ie8.min.js"></script>
<![endif]-->
<script async src="/yq/Public/editor/js/plugins/tables.min.js"></script>
<script async src="/yq/Public/editor/js/plugins/lists.min.js"></script>
<script async src="/yq/Public/editor/js/plugins/colors.min.js"></script>
<script async src="/yq/Public/editor/js/plugins/media_manager.min.js"></script>
<script async src="/yq/Public/editor/js/plugins/font_family.min.js"></script>
<script async src="/yq/Public/editor/js/plugins/font_size.min.js"></script>
<script async src="/yq/Public/editor/js/plugins/block_styles.min.js"></script>
<script async src="/yq/Public/editor/js/plugins/video.min.js"></script>

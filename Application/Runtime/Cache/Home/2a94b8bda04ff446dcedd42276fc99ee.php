...
<form id="add" class="add" method="POST" style="display: none;">
    <div style="background-color: #e5e5e5; width: 100%; height: 6%; padding-top: 4px; padding-bottom: 4px;"><span style="margin-left: 8%;">基本资料</span></div>
    <div class="settings-content"><span>账号</span><input class="add-account settings-input" type="text" name="username"></div>
    <div class="settings-content"><span>真实姓名</span><input class="add-realname settings-input" type="text" name="realname"></div>
    ...
    <div class="settings-content"><span>手机号码</span><input class="add-phone settings-input" type="text" name="phone"></div>
    <div style="background-color: #e5e5e5; width: 100%; height: 6%; padding-top: 4px; padding-bottom: 4px;"><span style="margin-left: 8%;">设置密码</span></div>
    <div class="settings-content"><span>密码</span><input class="newpassword settings-input" type="password" name="password"></div>
    <div class="settings-content"><span>确认密码</span><input class="confirmpassword settings-input" type="password" name="confirm_password"></div>

...
*/
function alert(){ 
    $str='<script type="text/javascript" src="/think_right/Public/statics/js/jquery-2.2.4.min.js"></script><script type="text/javascript" src="/think_right/Public/statics/layer/layer.js"></script>';//加载jquery和layer
    $str.='<script>$(function(){layer.msg("您没有做任何修改",{icon:5,time:'.(5*1000).'});setTimeout(function(){self.location.href="../User/my_center"},2000)});</script>';//主要方法
    return $str;
}
